...
export default function BranchesTable({
  ...
  const { data: branchesData, error: branchesError } = branches
  ...
  return (
    <div className="w-full p-6">
      ...
      {/* Table Header */}
      <div className="mb-4">
        <h2 className="text-2xl font-bold text-white mb-2">Branches</h2>
        <p className="text-gray-400">Manage branches</p>
      </div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span
                        className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                          branch.number_of_staff === 0
                            ? "bg-red-100 text-red-800"
                            : "bg-green-100 text-green-800"
                        }`}
                      >
                        {branch.number_of_staff === 0 ? "Empty" : "Full"}
                      </span>
                    </td>
