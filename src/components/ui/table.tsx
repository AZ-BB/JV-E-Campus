...
>(({ className, ...props }, ref) => (
    <th
        ref={ref}
        className={`text-left py-2 sm:py-3 px-2 sm:px-4 font-medium text-admin-text text-sm ${className}`}
        {...props}
    />
));
...
>(({ className, ...props }, ref) => (
    <td
        ref={ref}
        className={`py-2 sm:py-3 px-2 sm:px-4 text-sm text-admin-text ${className}`}
        {...props}
    />
));
